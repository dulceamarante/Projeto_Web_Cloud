...
// Importação do ficheiro CSS específico para o banner de homem
...
const Banner = () => {
 return (
   ...
   <section className="main-banner">
     {/* Contentor específico para o banner de homem */}
     <div className="banner-homem-container">
       {/* Área do conteúdo do banner */}
       <div className="banner-content">
         {/* Link que direciona para a página de produtos de homem */}
