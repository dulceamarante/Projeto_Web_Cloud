...
export default function TopProducts() {
  ...
  // Função para obter os produtos mais vendidos para beleza
  const getTopSellingWomenProducts = (count) => {
    // Filtra produtos por categoria 'beauty' (beleza)
  ...
  // Obter os 5 produtos mais vendidos para beleza
  ...
  // Retorna mensagem se não houver produtos para beleza
  ...
  return (
    ...
    <section className="top-products-section">
      {/* Título da secção para produtos de beleza */}
